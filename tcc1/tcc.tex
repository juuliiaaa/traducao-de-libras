...
Diante disso, este trabalho propõe desenvolver um sistema de tradução de Libras que articula visão computacional, aprendizado profundo e processamento de linguagem natural em um pipeline integrado. O objetivo é contribuir para a inclusão social com uma solução acessível e aplicável em contextos como atendimentos, ambientes educacionais e interações cotidianas.
