...
O reconhecimento isolado de gestos não é suficiente para uma comunicação fluida, dada a diferença gramatical entre a Libras e o Português. O módulo de NLP atua na camada de pós-processamento, realizando a conversão semântica e sintática dos sinais identificados. Este fundamento permite que o sistema organize as palavras reconhecidas em frases coerentes, tratando variações de tempo verbal, concordância e estrutura frasal, garantindo que a tradução final seja compreensível para o usuário ouvinte.
