...
\begin{enumerate}
    ...
    \item Selecionar, estruturar e pré-processar os datasets de Libras, aplicando técnicas de divisão de dados, \textit{data augmentation}, SMOTE e ponderação de classes para garantir a qualidade do treinamento;
