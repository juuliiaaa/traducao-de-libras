...
Para o reconhecimento de sinais dinâmicos em vídeo, onde o significado do gesto reside no movimento ao longo do tempo, utiliza-se a Long Short-Term Memory (LSTM). A LSTM é uma variante das Redes Neurais Recorrentes (RNN) projetada para superar o problema do desaparecimento do gradiente, permitindo que a rede retenha informações de frames passados por longos períodos.

A arquitetura da LSTM é composta por "portões" (gates) que controlam o fluxo de informação: o que deve ser esquecido, o que deve ser armazenado e o que deve ser passado para o próximo estado. No contexto de Libras, isso permite que o sistema compreenda que a trajetória de um movimento é tão importante quanto a pose final da mão para a tradução correta de uma frase.
